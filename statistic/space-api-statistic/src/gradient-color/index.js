...
function checkParam(array, n) {
  ...
  if (array[array.length - 1].frac) {
    throw new Error('The last element in the color array should not have a frac field');
  }

  // You need to see a doctor, like, right now
  if (n <= array.length) {
    throw new Error('The number of generated colors should >= the number of color stops');
  }
  ...
  if (typeof array[0] !== 'string') {
    ...
    if (fracSum < 0.99) {
      throw new Error('The sum of the fracs should = 1');
    }
  }
